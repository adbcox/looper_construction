  ...
  return (
    <Layout>
      <section className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        <h1 className="text-3xl font-semibold tracking-tight md:text-4xl">Gold Fortification</h1>
        <p className="mt-4 max-w-3xl text-sm leading-relaxed text-neutral-600">
          Placeholder for the current Gold Fortification content. Keep text verbatim when you paste it in.
        </p>
